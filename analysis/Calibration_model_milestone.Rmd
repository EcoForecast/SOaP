...
```{r}
# source file that downloads all of the data - only need to run once
...
Now let's set up our JAGS model code. We're including random effects for each sampling date, and fixed effects of minimum temperature and precipitation. This code is adapted from the JAGS output of ecoforecast::fit_dlm. 
```{r}
